...
func TestSerializeEncodingValidatesFieldsAndBounds(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "media type", value: `1`, encoding: `{"style":"form"}`,
			...
			want: media.ErrInvalidEncodingSerialization},
		{name: "empty media type", value: `1`, encoding: `{"style":"form"}`,
			mediaType: "/json", maximum: 10,
			want: media.ErrInvalidEncodingSerialization},
		{name: "empty media subtype", value: `1`, encoding: `{"style":"form"}`,
			mediaType: "application/", maximum: 10,
			want: media.ErrInvalidEncodingSerialization},
