...
func TestDecodeRejectsMalformedOrAmbiguousSerializations(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "deep invalid name escape", raw: "color%5BR%zz=100", shape: parameter.Object, options: parameter.Options{Version: version, Location: parameter.Query, Style: parameter.DeepObject}},
		...
		{name: "deep missing closing bracket", raw: "color%5BR=100", shape: parameter.Object, options: parameter.Options{Version: version, Location: parameter.Query, Style: parameter.DeepObject}},
